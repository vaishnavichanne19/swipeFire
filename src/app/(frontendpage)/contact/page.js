...
const Contact = () => {
  ...
  const branches = fetchAllData.slice(6);
  ...
  return (
    <main>
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 flex items-center justify-center">
              <div className="flex flex-col gap-6 px-8 py-14 md:px-12">
                ...
                {fetchAllData.slice(1, 4).map((data, index) => {
                  const icon = icons[index];

                  return (
                    <div
                      key={index}
                      className="flex gap-4 items-start pb-4 border-b border-white/60 last:border-0 last:pb-0"
                    >
                      ...
                      <div>
                        ...
                        <div
                          className="[&_*]:!text-md [&_*]:!text-white leading-relaxed"
                          dangerouslySetInnerHTML={{ __html: data.description }}
                        ></div>
                      </div>
                    </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2">
        {fetchAllData.slice(4, 5).map((data) => (
          <div
            key={data._id}
            className="px-8 py-14 md:px-12 border-b md:border-b-0 md:border-r border-black/80"
          >
            <p className="tracking-[0.18em] uppercase !text-[#c20016] font-medium mb-4">
              01 — Enquiry
            </p>
            <h2 className=" leading-snug  mb-4">{data.heading}</h2>
            <div
      ...
      <div className="container-fluid bg-[#f5f5f5] px-3 lg:!px-5 py-2 lg:!py-18">
        <div className="mb-9 text-center">
          ...
          {fetchAllData.slice(5, 6).map((data) => (
            <h2
              key={data._id}
        ...
        <div className="row flex flex-wrap justify-center">
          {fetchAllData.slice(6).map((branch, index) => (
            <div
              key={index}
              ...
              >
                <div>
                  ...
                  <div>
                    <h5>
                      <b
                        className="w-[100px]  md:w-full break-all"
