...
export default function UserInfoCard() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("/api/product/qualitypolicy");
  ...
  useEffect(() => {
    ...
    const fetchSingleData = async () => {
      try {
        const res = await axios.get(`/api/product/qualitypolicy/${editId}`);
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`/api/product/qualitypolicy/${editId}`, UpdateData);
