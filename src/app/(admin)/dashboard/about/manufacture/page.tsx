...
export default function UserInfoCard() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("/api/about/manufacture");
  ...
  useEffect(() => {
    ...
    const fetchSingleData = async () => {
      try {
        const res = await axios.get(`/api/about/manufacture/${editId}`);
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`/api/about/manufacture/${editId}`, UpdateData);
  ...
  const Deletedata = async (UserId: string) => {
    try {
      await axios.delete(`/api/about/manufacture/${UserId}`);
