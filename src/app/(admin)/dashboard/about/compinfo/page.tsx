...
export default function UserInfoCard() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("/api/about/compinfo");
  ...
  useEffect(() => {
    ...
    const fetchSingleData = async () => {
      try {
        const res = await axios.get(`/api/about/compinfo/${editId}`);
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`/api/about/compinfo/${editId}`, UpdateData);
