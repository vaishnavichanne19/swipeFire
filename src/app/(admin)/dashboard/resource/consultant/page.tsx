...
export default function UserInfoCard() {
  ...
  useEffect(() => {
    ...
    const fetchSingleData = async () => {
      try {
        const res = await axios.get(`/api/resource/consultant/${editId}`);
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`/api/resource/consultant/${editId}`, UpdateData);
              ...
              <div className="grid grid-cols-1 gap-4 lg:gap-7 2xl:gap-x-32">
                ...
                {data.designpoints && (
                  <div>
                    ...
                    <div
                      className="ck-content text-sm font-medium text-gray-800 dark:text-white/90"
                      dangerouslySetInnerHTML={{ __html: data.designpoints }}
                    />
                  </div>
                )}
                {data.checkpoints && (
                  <div>
                    ...
                    <div
                      className="ck-content text-sm font-medium text-gray-800 dark:text-white/90"
                      dangerouslySetInnerHTML={{ __html: data.checkpoints }}
                    />
                  </div>
                )}
              </div>
            ...
            <div className="custom-scrollbar h-[auto] overflow-y-scroll px-2 pb-3">
              <div className="mt-7">
                <div className="flex flex-col gap-4">
                  ...
                  {UpdateData.designpoints && (
                    <div className="col-span-2 lg:col-span-1">
                      <Label>Design Points</Label>
                      <CKEditorClient
                        value={UpdateData.designpoints}
                        onChange={(value: string) =>
                          setUpdateData({
                            ...UpdateData,
                            designpoints: value,
