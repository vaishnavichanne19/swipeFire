...
export default function UserInfoCard() {
  ...
  const Deletedata = async (UserId: string) => {
    try {
      await axios.delete(`/api/contact/${UserId}`);
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {fetchAllData.slice(0, 6).map((data) => (
          <div
            key={data._id}
