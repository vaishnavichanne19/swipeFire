...
export default function UserInfoCard() {
  ...
  const [fetchAllData, setFetchAllData] = useState<EquipmentData[]>([]);
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("/api/home/equipment");
  ...
  const Deletedata = async (UserId: string) => {
    try {
      await axios.delete(`/api/home/equipment/${UserId}`);
