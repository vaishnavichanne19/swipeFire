...
export default function UserInfoCard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/home/compinfo");
  ...
  const Deletedata = async (UserId: string) => {
    try {
      await axios.delete(`/api/home/compinfo/${UserId}`);
      setFetchAllData((prev) => prev.filter((user) => user._id !== UserId));
      toast.error("Data Deleted Successfully!");
      router.push("/dashboard/homepages/compinfo");
    } catch (error) {
