...
export default function UserInfoCard() {
  ...
  useEffect(() => {
    ...
    const fetchSingleData = async () => {
      try {
        const res = await axios.get(`/api/service/servicelist/${editId}`);
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`/api/service/servicelist/${editId}`, UpdateData);
  ...
  const Deletedata = async (UserId: string) => {
    try {
      await axios.delete(`/api/service/servicelist/${UserId}`);
      setFetchAllData((prev) => prev.filter((user) => user._id !== UserId));
      toast.error("Data Deleted Successfully!");
      router.push("/dashboard/homepages/homeservice");
    } catch (error) {
  ...
  return (
    <div>
      ...
      <div className="flex justify-end mr-4 my-5">
        <Link
          href="/dashboard/service/servicelist/addpage?from=homeservice"
              ...
              <div className="flex justify-end">
                <div className="relative inline-block ">
                  ...
                  <Dropdown
                    ...
                    className="w-40 p-2"
                  >
                    <Link href={`/dashboard/service/servicelist/${data._id}?from=homeservice`}>
                      <DropdownItem
                        tag="a"
