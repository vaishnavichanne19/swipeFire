...
const Update = () => {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      const res = await axios.get(`/api/home/certificate/${editid}`);
      if (res.data.success) {
  ...
  toast.error("Only SVG and Webp images allowed");
  return;
}
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await axios.put(`/api/home/certificate/${editid}`, formData);
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          ...
          <form onSubmit={handleUpdate} className="flex flex-col ">
            <div className="custom-scrollbar h-[auto] overflow-y-scroll px-2 pb-3">
              <div className="mt-7">
                <div className="flex flex-col gap-4">
                  ...
                  {UpdateData.certificateimage && (
                    <div className="grid grid-cols-1 gap-4 ">
                      {["certificateimage"].map((img) => (
                        <div key={img}>
                          ...
                          <Input
                            type="file"
                            accept=".svg,image/svg+xml,image/webp"
            ...
            <div className="flex items-center gap-3 px-2 mt-6 justify-end">
              <Link
                href="/dashboard/homepages/certificate"
