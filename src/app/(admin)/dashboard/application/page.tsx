...
export default function UserInfoCard() {
  ...
  useEffect(() => {
    ...
    const fetchViewData = async () => {
      try {
        const res = await axios.get(`/api/home/applicationsec/${ViewId}`);
  ...
  const Deletedata = async (UserId: string) => {
    try {
      await axios.delete(`/api/home/applicationsec/${UserId}`);
  ...
  return (
    <div>
      ...
      {fetchAllData.slice(1, 4).map((data) => (
        <div
          key={data._id}
                ...
                <div className="grid grid-cols-1 gap-4 lg:gap-7 2xl:gap-x-32">
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
                      {ViewData.applicationimage && (
                        <div className="h-[200px] w-auto lg:w-100 relative">
                          <Image
                            src={ViewData.applicationimage}
                            alt=" grid"
                            className="w-full border border-gray-200 rounded-xl dark:border-gray-800"
                            fill
                            objectFit="cover"
