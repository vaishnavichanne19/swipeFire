...
const AddData = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`/api/service/servicelist`, AddData);
        if (res.data.success) {
      toast.success("Data Added Successfully");
      router.push(from === "homeservice" ? "/dashboard/homepages/homeservice" : "/dashboard/service/servicelist");
    }
    } catch (error) {
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col ">
            ...
            <div className="flex items-center gap-3 px-2 mt-6 justify-end">
              <Link
                href={from === "homeservice" ? "/dashboard/homepages/homeservice" : "/dashboard/service/servicelist"}
