...
const Update = () => {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      const res = await axios.get(`/api/blog/bloglist/${editid}`);
      if (res.data.success) {
  ...
  const handleUpdate = async (e) => {
    ...
    formData.append("blogdetail", UpdateData.blogdetail);
    ...
    try {
      await axios.put(`/api/blog/bloglist/${editid}`, formData);
